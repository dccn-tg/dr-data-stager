...
// GetJobIDParams contains all the bound params for the get job ID operation
...
func (o *GetJobIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
