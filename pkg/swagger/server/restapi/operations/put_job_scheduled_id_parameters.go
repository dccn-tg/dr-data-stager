...
// PutJobScheduledIDParams contains all the bound params for the put job scheduled ID operation
...
func (o *PutJobScheduledIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
