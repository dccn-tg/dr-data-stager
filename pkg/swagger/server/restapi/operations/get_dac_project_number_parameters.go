...
// GetDacProjectNumberParams contains all the bound params for the get dac project number operation
...
func (o *GetDacProjectNumberParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDacProjectNumberParams) bindNumber(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
