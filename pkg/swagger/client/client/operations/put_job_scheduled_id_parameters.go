...
func NewPutJobScheduledIDParams() *PutJobScheduledIDParams {
	return &PutJobScheduledIDParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPutJobScheduledIDParamsWithTimeout creates a new PutJobScheduledIDParams object
...
// NewPutJobScheduledIDParamsWithContext creates a new PutJobScheduledIDParams object
...
// NewPutJobScheduledIDParamsWithHTTPClient creates a new PutJobScheduledIDParams object
...
PutJobScheduledIDParams contains all the parameters to send to the API endpoint
	...
	for the put job scheduled ID operation.
