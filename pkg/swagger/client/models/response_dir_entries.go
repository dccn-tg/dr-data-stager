...
func (m *ResponseDirEntries) validateEntries(formats strfmt.Registry) error {
...
func (m *ResponseDirEntries) contextValidateEntries(ctx context.Context, formats strfmt.Registry) error {
